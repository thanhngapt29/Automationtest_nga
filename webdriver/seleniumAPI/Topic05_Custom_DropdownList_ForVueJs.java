...
public class Topic05_Custom_DropdownList_ForVueJs {
	...
	public void TC_01_SelectCustomDrowdown_ForVueJs(String parentLocator, String itemLocator, String expectedItem) {
	...
	public void TC_02_searchAll()
	{
		...
		TC_01_SelectCustomDrowdown_ForVueJs("//div[@role='listbox']", "//div[@style='pointer-events:all']/span", "Christian");
		...
		Assert.assertEquals(driver.findElement(By.xpath("//span[text()='Christian']//parent::div")).getAttribute("aria-checked"), "true");
		...
		//Câu hỏi: Nếu là search ra cả ký tự hoa và thường matching thì làm thế nào
		// Trường hợp muốn chạy 2 case thì làm gì
